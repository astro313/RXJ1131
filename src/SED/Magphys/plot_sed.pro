...
; read,galaxy,prompt='Give the name of the source: ' 
  ;galaxy=command_line_args()
 fmt='A,F,I,I'
  filt=''
  readcol,'~/Documents/magphys/magphys_highz/Daisy/filters.dat',f=fmt,filt,lambda_eff,filter_id,fit  ;Reads the filter file 
...
position12=[0.775,0.07,0.90,0.22]
  ...
  plot,xx,y_at,/xlog,xr=[0.07,300000],yr=[5.,15.],ytitle=yt,xstyle=1,ystyle=1,thick=2,POSITION=[0.12,0.65,0.92,0.99],charsize=1.75,XTICKFORMAT="(A1)"
  ...
  oploterror,lambda_eff,L_flux,lambda_err,L_eflux_hi,psym=8,symsize=0.5,color=1,errcolor=1, /HIBAR
   xyouts,50000,11.5,name_xy,charthick=2,charsize=0.8
   xyouts,50000,11.,chi_t,charsize=0.8
   xyouts,80000,11.,STRTRIM(STRING(chi2, format='(F5.2)'),1),charsize=0.8
  
  plot,[0.07,300000],[0,0],lines=1,xr=[0.07,300000],yr=[-1.0,1.0],xtitle=xt,xstyle=1,ystyle=1,/xlog, $ 
...
;Histograms 
   ...
   plot,Ldust[0,*],Ldust[1,*],xr=[8.01,13.99],psym=10,xtitle=t6,xstyle=1,thick=5,ystyle=1,yr=[0,1],charsize=1.3,POSITION=position7,ytitle='Likehood Distr.'
   ...
   plot,Mdust[0,*],Mdust[1,*],psym=10,xtitle=t10,xr=[4.1,9.9],xstyle=1,thick=5,ystyle=1,yr=[0,1],charsize=1.3,POSITION=position8,YTICKFORMAT="(A1)"
   ...
   plot,sSFR[0,*],sSFR[1,*],psym=10,xtitle=t11,xr=[-12.9,-7.1],xstyle=1,thick=5,ystyle=1,yr=[0,1],charsize=1.3,POSITION=position5,YTICKFORMAT="(A1)"
