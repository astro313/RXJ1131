...
\tablenotetext{c}{Flux extracted from the residual map after subtracting a point-source model. For SED modeling, we use $S_{\rm 2mm}$\eq0.27\pmm0.22\,mJy to exclude synchrotron emission.}
