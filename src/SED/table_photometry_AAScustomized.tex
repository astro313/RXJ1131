...
2152.82 & 139.256 & 0.390 $\pm$ 0.220\tnc   & PdBI \\
...
\tablenotetext{c}{Flux extracted from the residual map after subtracting a point-source model. For SED modeling, we use $S_{\rm 2mm}$\eq0.27\pmm0.22\,mJy to exclude synchrotron emission (see \Sec{deblend}).}
