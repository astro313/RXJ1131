...
\startdata
0.555   & 540167  & 0.056 $\pm$ 0.006   & {\it HST}-ACS/V-Band (L) \\
...
\tablecomments{(H) and (L) in column 4 indicate the flux (in column 3) of RXJ1131 and its lensing galaxy, respectively.
The IRAC photometry at 3.6$\micron$ is extracted directly from the image and
from the Spitzer Heritage Archive for channels 2$-$4 (4.5, 5.8, and 8.0$\micron$). The upper limits are the 3$\sigma$ limits.}
\tablenotetext{a}{Flux obtained by subtracting the emission of RXJ1131 from the total emission within an aperture. }
\tablenotetext{b}{Flux extracted from the residual map after subtracting a point-source model.}
\tablerefs{The {\it HST} photometry is taken from C06.}
\end{deluxetable}
