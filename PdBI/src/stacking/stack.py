...
path = '/Users/admin/Research/RXJ1131/PdBI/data/27Dec15/'
print('-- change to directory: {:} ---').format(path)
os.chdir(path)

# run from casapy
uvAIPS = ['co21_trial1-noCont-ext0_17AIPS.uvfits',
          'co21_trial1-noCont-ext167_181AIPS.uvfits',
          'co21_trial1-noCont-ext267_281AIPS.uvfits']

uvFITS = ['co21_trial1-noCont-ext0_17.uvfits',
          'co21_trial1-noCont-ext167_181.uvfits',
          'co21_trial1-noCont-ext267_281.uvfits']
...
linems = ['co21_trial1-noCont-ext0_17.ms.contsub',
          'co21_trial1-noCont-ext167_181.ms.contsub',
          'co21_trial1-noCont-ext267_281.ms.contsub']

# line rest freq (i.e. redshifted @ z=0)
restfreq = ['138.04938GHz',
            '139.69637GHz',
            '140.70163GHz']
