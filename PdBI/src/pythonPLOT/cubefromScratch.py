...
Build a cube from scratch and fit many gaussians

Still need to figure out how to make it useful to what I do....
Seems like it fits model to spectrum, e.g. Gaussian, and return SNR.. what does this SNR mean..

Note
----
Run in ipython only, don't run under Daisy's alias='pylab' environment. It will crash for some reason.
