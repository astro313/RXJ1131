...
is steeply rising ($z$$\sim$0.3-1) is critical and we here aim to bridge this gap by testifying
...
\floatbox[{\capbeside\thisfloatsetup{capbesideposition={right,center},capbesidewidth=0.445\textwidth}}]{figure}[\FBwidth]
{
\includegraphics[trim=7 6 5 5, clip, width=0.575\textwidth]{Fig/combine}}
{
\hspace{-1.0em}
\caption{ \fontsize{10pt}{12pt}\selectfont {\textbf{ New \bco} data.}
{\em (a):}
