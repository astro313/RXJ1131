...
\old{The gas mass fraction of 
% $f_{\rm gas}$\eq\old{$\sim$19\% } \new{$\sim$18\pmm4\%} 
\mbox{$f_{\rm gas}$\eq$\sim$19\%}
is consistent with the trend of decreasing molecular gas fraction since $z$\ssim2 reported in recent studies.
