...
\newcommand{\old}[1]{\textcolor{red}{\st{#1}}} % {\textcolor{green!55!blue}{\bf #1}} or  {\textcolor{OliveGreen}{\bf #1}}
% -----------------------------------------------------------------------------------------------
...
as shown in \mbox{\Fig{CO21spec}}. Fitting a double Gaussian results in peak
...
Here, we find that the highly asymmetric \mbox{\bco} line profile is predominantly a result of
...
varies from 8.7 to 3.1 across the \mbox{\bco} line (\mbox{\Tab{model})}.
...
In the latter, \mbox{\citet{Sluse07a}} report a covering factor of 20\% based on \mbox{\mgii} absorption line at $z$\eq0.654.
Additionally, differentially lensing of the compact BLR emission by microlensing in RXJ1131 \mbox{\citep[\eg][]{Sluse07a, Sluse12a}}
