...
%DIF DEL ms_d94d9ac.tex   Mon Aug 29 20:08:57 2016
%DIF ADD ms.tex           Mon Aug 29 20:39:38 2016
\usepackage{amsmath}
...
\newcommand{\old}[1]{{\textcolor{airforceblue}{\bf #1}}} % {\textcolor{green!55!blue}{\bf #1}} or  {\textcolor{OliveGreen}{\bf #1}}
% -----------------------------------------------------------------------------------------------
...
\citestyle{aa}
\shorttitle{Molecular Gas Dynamics in the Strongly-lensed Quasar Host Galaxy RXJ1131$-$1231}
...
\title{Molecular Gas Dynamics of the Strongly-lensed Quasar Host Galaxy RXS J1131$-$1231}
...
RXS\,J1131$-$1231 (hereafter RXJ1131) at $z$\,=\,0.654 obtained using the
\pdbi (PdBI) and the \carma (CARMA).
Our lens modeling shows that the asymmetry \DIFdelbegin \DIFdel{of }\DIFdelend \DIFaddbegin \DIFadd{in }\DIFaddend the double-horned \bco line profile
is mainly a result of differential lensing, where
the magnification factor varies from $\sim$3 to $\sim$\DIFdelbegin \DIFdel{8 }\DIFdelend \DIFaddbegin \DIFadd{9 }\DIFaddend across
...
the \DIFdelbegin \DIFdel{quasar }\DIFdelend host galaxy is an extended rotating disk \DIFdelbegin \DIFdel{, with a CO size of $R\sim$}\DIFdelend \DIFaddbegin \DIFadd{of $R_{\rm CO}$$\sim$}\DIFaddend 6\,kpc \DIFdelbegin \DIFdel{in radius }\DIFdelend and
a dynamical mass of $M_{\rm dyn}$\ssim8\E{10}\,\Msun.
In addition, we find a secondary CO-emitting source near RXJ1131 whose location is
consistent with the optically-faint companion reported in previous studies.
\DIFdelbegin \DIFdel{We decompose the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend lensing-corrected \DIFdelbegin \DIFdel{total }%DIFDELCMD < \bco %%%
\DIFdel{line flux into two components and
find a lensing-corrected gas mass of }\DIFdelend \DIFaddbegin \DIFadd{molecular gas masses are }\DIFaddend $M_{\rm gas}$\ssim1.4\E{10}\,\Msun
\DIFdelbegin \DIFdel{for RXJ1131
}\DIFdelend and \ssim2\E{9}\,\Msun for \DIFaddbegin \DIFadd{RXJ1131 and }\DIFaddend the companion, \DIFdelbegin \DIFdel{corresponding
to a gas mass ratio of $\sim$7:1.
}\DIFdelend \DIFaddbegin \DIFadd{respectively.
}\DIFaddend The gas mass fraction of $\sim$19\% inferred for RXJ1131 is consistent with the trend of decreasing molecular gas fraction since $z$\DIFdelbegin %DIFDELCMD < \ssim1 %%%
\DIFdelend \DIFaddbegin \ssim2 \DIFaddend reported in recent studies.
\DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{We find }\DIFaddend lensing-corrected stellar \DIFdelbegin \DIFdel{mass }\DIFdelend \DIFaddbegin \DIFadd{and dust masses, IR luminosity, and
star formation rate of
}\DIFaddend $M_{*}$\ssim3\E{10}\,\Msun, \DIFdelbegin \DIFdel{dust mass }\DIFdelend $M_{\rm dust}$\ssim4\E{8}\,\Msun, \DIFdelbegin \DIFdel{IR luminosity }\DIFdelend $L_{\rm IR}$\ssim1.5\E{12}\,\Lsun,  and \DIFdelbegin \DIFdel{star formation rate }\DIFdelend SFR$_{\rm FIR}$\DIFdelbegin %DIFDELCMD < \eq120\pmm63 %%%
\DIFdelend \DIFaddbegin \ssim120\,\DIFaddend \sfrU \DIFdelbegin \DIFdel{of }\DIFdelend \DIFaddbegin \DIFadd{for }\DIFaddend RXJ1131\DIFdelbegin \DIFdel{together with its }\DIFdelend \DIFaddbegin \DIFadd{.
The }\DIFaddend source-plane \DIFdelbegin \DIFdel{morphology of the }\DIFdelend \DIFaddbegin \DIFadd{morphologies of its }\DIFaddend gas and stellar populations
indicate \DIFdelbegin \DIFdel{ongoing }\DIFdelend \DIFaddbegin \DIFadd{that the }\DIFaddend star-formation activity \DIFdelbegin \DIFdel{that maybe }\DIFdelend \DIFaddbegin \DIFadd{may be }\DIFaddend as extended as the molecular gas reservoir.
We find a $M_{\rm BH}$/$M_{\rm bulge}$ ratio of \DIFaddbegin \DIFadd{$>$}\DIFaddend 0.27\petm{11}{8}\% that is higher
than the local value
but consistent with other galaxies at this epoch\DIFdelbegin \DIFdel{. Collectively, our results suggest
}\DIFdelend \DIFaddbegin \DIFadd{, suggesting }\DIFaddend that the bulk of the black hole mass of RXJ1131 is already in place while its stellar bulge \DIFdelbegin \DIFdel{component }\DIFdelend is still assembling\DIFdelbegin \DIFdel{, and that its major mode of }%DIFDELCMD < \SF %%%
\DIFdel{is likely merger-driven}\DIFdelend .
\end{abstract}
...
\DIFdelend \DIFaddbegin \DIFadd{{infrared: galaxies --
          galaxies: high-redshift --
          galaxies: ISM --
          galaxies: evolution --
          quasars: individual (RXS\,J1131$-$1231) --
          radio lines: ISM}}}\DIFaddend
...
\SF efficiency \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep[]{Erb06a, CW13, Walter14a}
}%DIFAUXCMD
,
but confirmation from }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep[e.g.,][]{Erb06a, CW13, Walter14a}
}%DIFAUXCMD
,
but }\DIFaddend direct molecular gas measurements at intermediate redshift
$(0.2\,<\,z\,<\,1)$ \DIFdelbegin \DIFdel{is still limited both in number and in the variety of galaxy populations probed ---
only }\DIFdelend \DIFaddbegin \DIFadd{that could confirm this explanation remain largely limited to
spatially }\DIFaddend unresolved CO observations \DIFdelbegin \DIFdel{have been carried out for }\DIFdelend \DIFaddbegin \DIFadd{of }\DIFaddend $\sim$$30$ ultra-luminous infrared galaxies \DIFdelbegin \DIFdel{(ULIRGs) up to date \mbox{%DIFAUXCMD
\citep{Combes11a, Combes13a}
}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep[ULIRGs; ][]{Combes11a, Combes13a}
}%DIFAUXCMD
}\DIFaddend . %18+15

Meanwhile, empirical scaling relations such as the
$M_{\rm BH}$$-$\mbulge relation \citep[e.g.,][]{Magorrian98a, HR04a}
\DIFdelbegin \DIFdel{has }\DIFdelend \DIFaddbegin \DIFadd{have }\DIFaddend been established locally, suggesting a co-eval growth between local SMBHs and their host galaxies.
...
%DIF <  the $M_{\rm BH}$$/$$M_{\rm bulge}$ ratios of high-$z$ submillimeter galaxies (SMGs)
%DIF <  are lower than those of local AGN host galaxies \citep[\eg][]{Borys05a,Alexander08a},
%DIF <  whereas those of high-$z$ quasar host galaxies
%DIF <  are higher than the local values \citep[\eg][]{Walter04a, McLure06a,Peng06a, Riechers08a,Coppin08a},
%DIF <  suggesting that the co-eval growth of high-$z$ AGNs and their host galaxies follows different
%DIF <  timescales compared to their local counterparts. % different AGN mechanism, different AGN accretion rate
%DIF <  However, any links between such fast-growing SMBHs and their host galaxies are not yet established at these high redshifts.
high-$z$ AGN host galaxies do not \DIFaddbegin \DIFadd{appear to }\DIFaddend follow the same $M_{\rm BH}$$-$\mbulge relation \DIFaddbegin \DIFadd{as nearby spheroidal galaxies. }\DIFaddend \citep[\eg][]{Walter04a,Borys05a, McLure06a,Peng06a, Riechers08a,Coppin08a,Alexander08a}.
Yet, the $M_{\rm BH}$$-$\mbulge relation remains poorly-constrained
at intermediate redshifts.
This is owed to the difficulties in
measuring stellar emission in \DIFdelbegin \DIFdel{optical }\DIFdelend quasar host galaxies \DIFdelbegin \DIFdel{, where
emission of quasars produces sidelobes that saturate the lower surface brightness starlight in the host galaxy,
or alternatively, due to the lack of spatially resolved CO observations to provide dynamical constraints on the stellar
(bulge) mass}\DIFdelend \DIFaddbegin \DIFadd{which is typically
saturated by the sidelobes from their quasars}\DIFaddend .
With strong gravitational lensing, emission from the background quasar and its host galaxy originating from
different source-plane locations \DIFdelbegin \DIFdel{and of different }\DIFdelend \DIFaddbegin \DIFadd{with different spatial }\DIFaddend extent is being magnified and stretched out \DIFdelbegin \DIFdel{by different amount.
The lensed emission is therefore }\DIFdelend \DIFaddbegin \DIFadd{inhomogenously,
allowing their emission to be
}\DIFaddend spatially resolved over more beams \DIFdelbegin \DIFdel{which reduces the sidelobes and enables
}\DIFdelend \DIFaddbegin \DIFadd{to reduce the dynamic range, and thus
}\DIFaddend measurements of the stellar emission in the host galaxy.
...
In this paper, we present \bco and \cco line \DIFdelbegin \DIFdel{data observed towards RXJ1131 }\DIFdelend \DIFaddbegin \DIFadd{observations }\DIFaddend and
broadband photometry spanning rest-frame UV to radio wavelengths \DIFaddbegin \DIFadd{towards RXJ1131 }\DIFaddend to
study the properties of \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{its }\DIFaddend molecular gas, the dust and stellar populations\DIFdelbegin \DIFdel{in the
host galaxy of RXJ1131}\DIFdelend .
In \Sec{obs}, we outline details of the observations and of our data reduction procedures.
In \DIFdelbegin %DIFDELCMD < \Sec{HST}%%%
\DIFdel{, we describe the astrometric corrections
applied to an image taken with the }%DIFDELCMD < \hst %%%
\DIFdel{(}%DIFDELCMD < {\it %%%
\DIFdel{HST}%DIFDELCMD < }%%%
\DIFdel{) by aligning it to
a radio image taken with the }%DIFDELCMD < \vla %%%
\DIFdel{(VLA).
In }\DIFdelend \Sec{results}, we report \DIFdelbegin \DIFdel{measurements of }\DIFdelend \DIFaddbegin \DIFadd{results for }\DIFaddend the \bco and \cco \DIFdelbegin \DIFdel{lines }\DIFdelend \DIFaddbegin \DIFadd{emission }\DIFaddend and broadband
photometry in RXJ1131.
In \Sec{anal}, we present \DIFdelbegin \DIFdel{dynamical lens modeling }\DIFdelend \DIFaddbegin \DIFadd{lens modeling and dynamical modeling }\DIFaddend of the \bco data and
...
an effective bandwidth of 3.6 GHz (dual polarization) and a spectral resolution of \DIFdelbegin \DIFdel{10.0 }\DIFdelend \DIFaddbegin \DIFadd{1.95}\,\DIFaddend MHz
($\sim$\DIFdelbegin \DIFdel{$21.5$ }\DIFdelend \DIFaddbegin \,\DIFadd{$4.2$}\,\DIFaddend \kms).
\DIFdelbegin %DIFDELCMD < {\bf %%%
\DIFdel{DR: DSB, 320 MHz/128 channels? <-> 2.5 MHz? I did not bin the data}%DIFDELCMD < }
%DIFDELCMD < %%%
\DIFdelend The nearby quasars B1127$-$145 and B1124$-$186 were observed every 22 minutes
...
a calibration accuracy of $\sim$\DIFdelbegin \DIFdel{35}\DIFdelend \DIFaddbegin \DIFadd{40}\DIFaddend \% based on the flux scale uncertainties,    %DIF >  ~40 = usual CARMA ~15-20% + 35% add in quad
...
\DIFdelbegin \section{\DIFdel{HST astrometry}} %DIFAUXCMD
\addtocounter{section}{-1}%DIFAUXCMD
%DIFDELCMD < \label{sec:HST}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsection{\DIFadd{HST (Archival)}}
\DIFaddend We obtained an {\it HST} image taken with
the ACS
...
We \DIFdelbegin \DIFdel{adopt the }\DIFdelend \DIFaddbegin \DIFadd{apply astrometric correction to the optical image by adopting the }\DIFaddend VLA 5\,GHz map as the
reference coordinate frame\DIFdelbegin \DIFdel{to align the optical ($V$-band) image}\DIFdelend .
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \vspace{.2em}
\DIFaddend % moment 0 map, highest SNR: CASA chan=125~159 <=> GILDAS 126-160 <=> python 125-160
...
nearby ULIRGs and high-$z$ quasars \citep[e.g.,][]{Weiss07a, CW13}, \DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{but }\DIFaddend also
...
We detect \DIFdelbegin \DIFdel{PdBI }\DIFdelend 2\,mm continuum emission \DIFdelbegin \DIFdel{, as shown in }%DIFDELCMD < \Fig{cont}%%%
\DIFdel{. The }\DIFdelend \DIFaddbegin \DIFadd{at an
 }\DIFaddend integrated flux density \DIFdelbegin \DIFdel{is
}\DIFdelend \DIFaddbegin \DIFadd{of
}\DIFaddend 1.2\pmm0.2 mJy, with a peak flux of
$S_{\nu}$\,=\,799\pmm88\,$\mu$Jy\,beam\pmOne
centered on the lensing galaxy \DIFaddbegin \DIFadd{(}\Fig{cont}\DIFadd{)}\DIFaddend . Slightly extended emission
...
We subtract a point source model in the $uv$-plane to remove the unresolved
emission \DIFdelbegin \DIFdel{towards }\DIFdelend \DIFaddbegin \DIFadd{which we here assume to be dominated by }\DIFaddend the foreground galaxy. The peak flux (0.39\,$\pm$\,0.08\,mJy)
...
The quoted uncertainty is from the flux measurement in the residual map and \DIFdelbegin \DIFdel{do }\DIFdelend \DIFaddbegin \DIFadd{does }\DIFaddend not account for that in the de-blending procedure, where we have assigned 100\% of the point source flux to the foreground galaxy.
We report the peak flux in the original map
($S_{\nu}$\,=\,799\pmm88\,$\mu$Jy\,beam\pmOne) for the foreground galaxy\DIFdelbegin \DIFdel{.
We note that this peak flux density is only our best estimate }\DIFdelend \DIFaddbegin \DIFadd{, which
is the best estimate possible }\DIFaddend at the resolution of our observations, \DIFaddbegin \DIFadd{but we acknowledge that }\DIFaddend a non-negligible contribution from the background source to the \DIFdelbegin \DIFdel{total integrated (blended) flux may be present}\DIFdelend \DIFaddbegin \DIFadd{peak flux cannot be ruled out}\DIFaddend .
% The quote uncertainty on the flux density of the foreground galaxy based on the peak flux density
% assumes that the foreground galaxy is a point source, the...
...
\DIFdelbegin \DIFdel{Models of each slice thus provide information on
the corresponding kinematic component of the CO gas,
enabling us to reconstruct a velocity gradient in the source plane.
%DIF <
}\DIFdelend \DIFaddbegin \DIFadd{Our approach is similar to \mbox{%DIFAUXCMD
\citet{Riechers08a}
}%DIFAUXCMD
, who reconstruct a source-plane
velocity gradient and constrain the gas dynamics in a $z$}\,\DIFadd{$>$}\,\DIFadd{4 quasar PSS J2322$+$1944,
whose host galaxy is also lensed into an Einstein ring configuration.
}\DIFaddend To ensure adequate SNRs for lens modeling, we bin the frequency channels by a factor of five
...
%DIF <
\DIFdelbegin \DIFdel{The first use of a dynamical lens modeling approach is presented by \mbox{%DIFAUXCMD
\citet{Riechers08a}
}%DIFAUXCMD
, who reconstruct a source-plane
velocity gradient and constrain the gas dynamics in a $z$}%DIFDELCMD < \,%%%
\DIFdel{$>$}%DIFDELCMD < \,%%%
\DIFdel{4 quasar PSS J2322$+$1944,
which is also the only other similar system whose host galaxy is lensed into an Einstein ring configuration.
}\DIFdelend
...
direction (1\farcs5).
The spectra map covers an extent of $\sim$10\DIFdelbeginFL \DIFdelFL{"}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{''}\DIFaddendFL $\times$10\DIFdelbeginFL \DIFdelFL{"
}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{''
}\DIFaddendFL centered on the pixel that corresponds to coordinates of the lensing galaxy ($\alpha_{\rm J2000}$\,=\,11$^{\rm h}$31$^{\rm m}$51\fs44, $\delta_{\rm J2000}$\,=\,$-$12\degr31\arcmin58\farcs3).
...
Fitting two Gaussians with a \DIFdelbegin \DIFdel{single }\DIFdelend \DIFaddbegin \DIFadd{common }\DIFaddend FWHM
...
\DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{are }\DIFaddend seen in \Fig{CO21mom}. While beam smearing is inevitably the
...
We perform non-linear least \DIFdelbegin \DIFdel{square }\DIFdelend \DIFaddbegin \DIFadd{squares }\DIFaddend fitting using an orthogonal distance
...
Pearson coefficient $R$\,=\,0.998, and 0.027 between $V_{a}$ and $V_0$. % beam smearing --> not resolving velocity info. within the beam
...
out to radius beyond the disk scale-length and half-light radius \DIFdelbegin \DIFdel{--
}\DIFdelend \DIFaddbegin \DIFadd{---
}\DIFaddend is not equivalent to the maximum observed velocity ($V_{\rm max}$),
...
terminology)\DIFaddbegin \DIFadd{, }\DIFaddend since this corresponds to the radius at which the velocity
...
the \DIFaddbegin \DIFadd{relative compactness observed in the }\DIFaddend $V$-band \DIFdelbegin \DIFdel{compactness }\DIFdelend may be explained in part
due to the fact that \DIFdelbegin \DIFdel{its emission }\DIFdelend \DIFaddbegin \DIFadd{the emission in this band }\DIFaddend is
more susceptible to dust extinction than in other bands and/or \DIFaddbegin \DIFadd{dominated by
}\DIFaddend a central starburst caused by higher
...
\DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{Since the }\DIFaddend $V$-band dynamical mass is substantially lower than the gas mass,
 \DIFdelbegin \DIFdel{which
may be an indication of the dusty nature of the companion.
%DIF <  in which the $V$-band source size to
%DIF <  appear much smaller than its true extent.
}\DIFdelend \DIFaddbegin \DIFadd{the $V$-band emitting region may appear to be much smaller than its true extent due
to dust obscuration.
}\DIFaddend
...
We thus classify the system as a {\em \DIFaddbegin \DIFadd{gas-rich,}\DIFaddend ``wet'' minor merger}.
...
\DIFdelbegin \DIFdel{We note the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend \fir luminosity is comparable in both models, which is
...
We thus find a stellar mass of \DIFdelbegin \DIFdel{$M^*$}\DIFdelend \DIFaddbegin \DIFadd{$M_*$}\DIFaddend \eq2.95\petm{1.32}{0.86}\E{10}\,\Msun, which
...
%DIF <  Assuming a \citet{Salpeter55a} IMF, we find a ``stellar mass build-up" time (aka mass-doubling timescale) of $M^*$$/$SFR\eq sSFR\pmOne\ssim440 Myr for RXJ1131.
%DIF >  Assuming a \citet{Salpeter55a} IMF, we find a ``stellar mass build-up'' time (aka mass-doubling timescale) of $M^*}/$SFR\eq sSFR\pmOne\ssim440 Myr for RXJ1131.
...
In this section, we derive the gas properties of the merging system \DIFaddbegin \DIFadd{RXJ1131
}\DIFaddend based on \bco and compare them with those reported by
...
\subsubsection{\DIFdelbegin \DIFdel{Linewidth }\DIFdelend \DIFaddbegin \DIFadd{Linewidths }\DIFaddend and Sizes} \label{sec:sizes}
...
The wider CO linewidth observed in RXJ1131 also supports \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{a }\DIFaddend merger picture.

The CO gas in RXJ1131 is $\sim$6\pmm3\,kpc in radius (in the source plane),
which is more
extended than the average of \DIFaddbegin \DIFadd{3.5}\pmm2\DIFadd{.3}\,\DIFadd{kpc in }\DIFaddend a sample of disk-like U/LIRGs studied by
...
\subsubsection{Gas Mass Fractions \DIFaddbegin \DIFadd{and Gas-to-dust Ratio}\DIFaddend }
...
and a baryonic gas mass fraction of $f_\textrm{mol}$\eq$M_{\rm gas}$/($M_{\rm gas} + M^*$)\eq32\DIFdelbegin %DIFDELCMD < \petm{7}{-12}%%%
\DIFdelend \DIFaddbegin \petm{7}{12}\DIFaddend \% for RXJ1131.
% The derived gas fraction of suggests that $\sim$70\% of the available baryonic mass has already been converted into stars.
Recent studies find that the baryonic gas fraction of starburst galaxies has decreased from \DIFdelbegin \DIFdel{$\sim$40}\DIFdelend \DIFaddbegin \DIFadd{$f_{\rm mol}$}\ssim40\DIFaddend \% to $\lesssim$10\% between $z$\ssim2 and $z$\ssim0 \citep[\citetalias{Solomon97a};][]{GS04a, Tacconi06a},
% On the other hand,
...
normal ``star-forming'' galaxies \citep{Geach11a, Saintonge11a, Tacconi13a}\footnote{These authors use the ``Galactic'' \DIFaddbegin \DIFadd{value of
}\DIFaddend \alphaco\DIFdelbegin \DIFdel{conversion factor }\DIFdelend \DIFaddbegin \eq4\DIFadd{.6}\,\alphaU \DIFaddend to compute the molecular gas mass.}.
Both the dynamical and baryonic gas mass fractions of RXJ1131 are thus consistent with the trend of decreasing molecular gas content since $z$\ssim2 %(e.g., \citealt{Lagos11a, Popping12a, Genzel15a})
...
40\pmm34\DIFdelbegin \DIFdel{, which }\DIFdelend \DIFaddbegin \DIFadd{.
This }\DIFaddend would be a factor of two higher if we \DIFdelbegin \DIFdel{adopted }\DIFdelend \DIFaddbegin \DIFadd{were to adopt }\DIFaddend a dust mass from the other SED fit that is unconstrained at 24\,$\micron$.
This GDR is lower than the statistical average of 206
in the \citetalias{Combes13a} sample but is well within the broad
range of values measured over \DIFdelbegin \DIFdel{the entire sample }\DIFdelend \DIFaddbegin \DIFadd{their entire sample ($\sim$1$-$770)}\DIFaddend .
Our ratio is also consistent with high-$z$ SMGs
% \citep[78\pmm26;][]{Bothwell13a}
\citep[]{Bothwell13a} and
local ULIRGs \citep{Wilson08a}, but lower than \DIFaddbegin \DIFadd{that of }\DIFaddend the Milky Way by
$\sim 4\sigma$ \citep[ignoring systematic uncertainties;][]{Li01a,Zubko04a,Draine07a}.
\DIFdelbegin %DIFDELCMD < \defcitealias{Bothwell13a}{B13}
%DIFDELCMD < %%%
\DIFdelend

There are a number of systematic uncertainties associated with the derived gas-to-dust ratio\DIFdelbegin \DIFdel{. For instance, }\DIFdelend \DIFaddbegin \DIFadd{, in particular
}\DIFaddend the mass opacity coefficient $\kappa$,
...
We note that this gas mass is physically \DIFdelbegin \DIFdel{feasible }\DIFdelend \DIFaddbegin \DIFadd{possible }\DIFaddend based on the dynamical mass constraints derived in \Sec{dyn}.
...
be more extended than the \DIFaddbegin \DIFadd{optically thick }\DIFaddend dust. Consequently, the overall magnification factor
...
\DIFdelbegin %DIFDELCMD < \defcitealias{Tacconi08a}{T08}
%DIFDELCMD < %%%
\DIFdelend
...
The specific star formation rate (sSFR\eq SFR/\DIFdelbegin \DIFdel{$M^*$}\DIFdelend \DIFaddbegin \DIFadd{$M_*$}\DIFaddend ) of 4\petm{2.6}{2.4}\,Gyr\pmOne derived for RXJ1131
is $\lesssim$1.5$\sigma$ above the main sequence according to
the redshift-dependent ``main sequence\DIFdelbegin \DIFdel{" }\DIFdelend \DIFaddbegin \DIFadd{'' }\DIFaddend relation in \citet[and references therein]{Tacconi13a}\DIFdelbegin \DIFdel{but is
consistent with those of the \mbox{%DIFAUXCMD
\cite{dacunha10a}
}%DIFAUXCMD
sample of local ULIRGs, suggesting that the
majority of }%DIFDELCMD < \SF %%%
\DIFdel{in }\DIFdelend \DIFaddbegin \DIFadd{.
%DIF >   and is consistent with those of the \cite{dacunha10a} sample of local ULIRGs.
Given that }\DIFaddend RXJ1131 \DIFdelbegin \DIFdel{could be driven by its interactions with the companion galaxy,
unlike most disk galaxies despite sharing }\DIFdelend \DIFaddbegin \DIFadd{share }\DIFaddend similar \SF rate, \SF efficiency, and CO disk size \DIFaddbegin \DIFadd{as other ``main sequence'' disk galaxies,
the slight enhancement in sSFR suggests
that the }\SF \DIFadd{in RXJ1131 may be predominantly driven by interactions with the companion}\DIFaddend .
...
\DIFdelbegin %DIFDELCMD < \defcitealias{Sluse07a}{S07}
%DIFDELCMD < %%%
\DIFdel{\mbox{%DIFAUXCMD
\citet[hereafter S07]{Sluse07a}
}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet[]{Sluse07a}
}%DIFAUXCMD
}\DIFaddend report two sets of AGN lines observed in RXJ1131.
...
We find a $M_{\rm BH}$$/$$M_{\rm bulge}$\DIFdelbegin \DIFdel{ ratio of 0.27\petm{11}{8}\%
using the black hole mass of }\DIFdelend \DIFaddbegin \DIFadd{ ratio of $>$0.27\petm{11}{8}\%
using the black hole mass of }\DIFaddend $M_{\rm BH}$\ssim8\E{7}\,\Msun \citep{Sluse12a}
and the stellar mass derived in \Sec{SED} as an upper limit to the bulge mass.
This ratio is consistent with those of other intermediate-$z$ radio-loud AGNs
\citep{McLure06a}
but is higher than those of nearby AGNs \citep{HR04a}, supporting the emerging picture that quasars
grow faster and/or earlier than their host galaxies at higher redshifts
\citep[e.g., ][]{Walter04a, Peng06a, McLure06a,Riechers08a}.
The elevated $M_{\rm BH}$$/$$M_{\rm bulge}$ ratio of RXJ1131 compared to local AGNs
suggests that the bulk of the black hole mass of RXJ1131 is already in place while its stellar bulge is still assembling.
...
\old{between the \bco and \cco lines.
Taking into account the large phase errors associated with the \cco measurement, this ratio
is consistent with thermalized excitation but also with the lower excitation seen in normal star-forming disks.}
\new{between the \bco and \cco lines,
...
vary from $\mu_{\rm L}$\ssim3 to \old{$\sim8$}\new{$\sim$9} across channels. This is indicative of an extended molecular gas
distribution in the host galaxy of RXJ1131, and that different kinematic components
of the gas are magnified \old{inhomogeneously.} \new{inhomogeneously, similar to what was found for the $z$$>$4 quasar
...
suggest that the system is a \new{gas-rich,} ``wet'' minor merger.

Fitting dust SED models to the IR-to-mm photometry, we derive
\new{a} lensing-corrected dust mass of $M_{\rm dust}$\ssim4\E{8}\,\Msun,
\new{an} infrared luminosity of \LIR$\sim$\,1.5\E{12}\,$(5.5/\mu_{\rm L})$\,\Lsun,
...
whereas regions of recent \SF  \old{maybe}\new{may be}
embedded within the molecular gas reservoir as a result of
...
\old{maybe}\new{may be}
Hence, the true extent of recent \SF \old{maybe}\new{may be}
 as extended as the molecular gas.
...
\old{However, we find a sSFR\ssim4 Gyr\pmOne that is $\lesssim$1.5$\sigma$ higher than the main sequence, suggesting
that the majority of star formation in RXJ1131 could be driven by its interactions with the companion galaxy.
The merger nature and extended gas disk are likely the explanations for RXJ1131 to display
characteristics resembling both \SB and disk galaxies.}
\new{We find a specific \SF rate (sSFR\ssim4 Gyr\pmOne) that is $\lesssim$1.5$\sigma$ higher than those of ``main sequence'' galaxies.
The slight enhancement in sSFR suggests that
the on-going star formation in RXJ1131 could be driven by interactions with the companion.}
Recent \old{theoretical simulations}\new{simulations} have illustrated that the disk component of a gas-rich
...
gravitational torques provided by stellar components is reduced in such a system \new{\citep{Springel05a, Robertson06a, Hopkins09a}}.
% and the gas rapidly reform a cold disc in the background.
...
% This model requires a merged BH, this interpretation would imply that RXJ1131 was
% in a previous merger.  %, which would also explain the highly spinning black hole.
...
$M_{\rm BH}$$/$$M_{\rm bulge}$\new{$>$}0.27\petm{11}{8}\% for  of RXJ1131, providing
