...
\newcommand{\old}[1]{\textcolor{airforceblue}{\st{#1}}} % {\textcolor{green!55!blue}{\bf #1}} or  {\textcolor{OliveGreen}{\bf #1}}
% -----------------------------------------------------------------------------------------------
...
\title{Molecular Gas \old{Dynamics} \new{Kinematics} of the Strongly-lensed Quasar Host Galaxy RXS J1131$-$1231}
...
The gas mass fraction of \old{$\sim$19\% } \new{$\sim$18\%} inferred for RXS\,J1131$-$1231 is consistent with the trend of decreasing molecular gas fraction since $z$\ssim2 reported in recent studies.
We find lensing-corrected stellar and dust masses, an IR luminosity, and a
star formation rate of
$M_{*}$\ssim3\E{10}\,\Msun, $M_{\rm dust}$\ssim\old{4}\new{3}\E{8}\,\Msun, $L_{\rm IR}$\ssim1.5\E{12}\,\Lsun,  and SFR$_{\rm FIR}$\ssim120\,\sfrU for RXS\,J1131$-$1231.
...
\new{The observed properties of \bco and \cco emission are summarized in \Tab{obsprop}.
\input{table_obsprop}}

\subsection{\bco Emission} \label{sec:CO21}
We detect \bco line emission toward the background source in the PdBI data
at $\gtrsim$\,27$\sigma$ significance, \old{confirming the redshift at $z_{\rm CO}$\eq0.6537\,$\pm$\,0.0005.} \new{enabling us to constrain its redshift at
...
}}. \old{The emission is spatially and dynamically resolved} \new{The emission is spatially and kinematically resolved}
...
$\Delta v_{\rm sep}$\eq400\pmm12\,\kms. The total integrated line flux is \old{24.1\,$\pm$\,2.3 Jy \kms} \new{20.3\,$\pm$\,0.6 Jy \kms}. % see 15May16/
...
The velocity scale is with respect to \old{$z$\,=\,0.6537, which is approximately the line center considering the asymmetry resulting from differential lensing.} \new{$z$\,=\,0.6541, which corresponds to the line center of RXJ1131 based on
...
\old{\mbox{the lensed knots (see \Fig{CO21mom}).}}
\new{The deconvolved source size FWHM from fitting a single two-dimensional Gaussian
...
\old{35.7\,$\pm$\,21.9 Jy\,\kms} \new{35.7\,$\pm$\,6.9\,Jy\,\kms} by summing up fluxes over the FWZI
...
\new{0.78\,$\pm$\,0.62, where this uncertainty includes
...
The velocity scale is with respect to \old{\mbox{$z$=0.6537, which corresponds to the
dynamical center of the \bco line.}} \new{\mbox{$z$=0.6541, which corresponds to the
...
\new{We note that the reported flux uncertainties do not include those from absolute flux calibration.}
...
We therefore adopt \old{$S_{\nu}$ = 0.39\pmm0.08 mJy} \new{$S_{\nu}$\eq0.39\pmm0.22 mJy} as the 2\,mm continuum flux measurement for
the background galaxy (RXJ1131).
\old{The quoted uncertainty is from the flux measurement in the residual map, }
\new{The quoted uncertainty is solely based on the uncertainties associated with the flux density of the
...
\new{Contours correspond to [10, 40, 60, 100]\%$\times$ the peak flux density of $S_{\rm 5GHz}$\eq0.74\pmm0.01 mJy.}
...
We find a spectral index of $\alpha^{\rm 2mm}_{\rm 6cm}$\,=\,$-$\old{0.024}\new{0.02}
for the foreground galaxy and $\alpha^{\rm 2mm}_{\rm 6cm}$\,=\,$-$\old{0.345}\new{0.35}
for the background galaxy by fitting
power-laws ($S_\nu \propto \nu^{\alpha}$) to their continuum emission at
5\,GHz and 2\,mm.
\new{The spectral slope derived for the background source is flatter than the typical slope of pure synchrotron emission ($\alpha$\ssim$-$0.7), suggesting
...
Hence, we reconstruct the intrinsic \old{dynamics} \new{line profile and source-plane velocity structure }
...
emission (red) overlaid on} \new{around the annotated central velocity where
...
This can be explained by the difference in magnification factor \mbox{$(\mu_{\rm L})$} which
...
\new{\protect{Previous studies of RXJ1131 find evidence for differential lensing across
...
\new{As discussed in \Sec{caveat}, we interpret RXJ1131 as a disk galaxy given
...
by slicing across their source plane positions \new{along this major axis} (PA: 121\degr).
...
\caption{Left: \old{Source-plane positions from best-fit \mbox{\bco} lens models are indicated with their associated uncertainties atop
the observed first moment map}
\new{Source-plane positions obtained from the best-fit lens models (presented in \mbox{\Sec{lensmodel}}) are shown
...
Right: PV slice extracted along the fitted major axis at PA\,=\,121\degr \new{based on
...
$V_{\rm rot}$\,=\,\old{345}\new{303}\,$\pm$\,55\,\kms at 6\,$\pm$\,3\,kpc
...
Using a rotational velocity $V_{\rm rot} \, \sin\, i$\,=\,\old{345}\new{303}\,\kms (see \Sec{dynamics}),  % uncorrected for inclination
...
dust mass of 16\petm{5}{12}\E{8}\,\Msun, \new{all of which are} uncorrected for lensing \new{magnification}.
...
\LIR (rest-frame 8\,$-$\,1000\,\micron) of \old{\mbox{9.71\petm{6.14}{-6.05}\E{12}\,\Lsun}} \new{\mbox{8.67\petm{5.27}{5.27}\E{12}\,\Lsun}},
a \fir luminosity \LFIR of \old{\mbox{4.72\petm{2.54}{2.26}\E{12}\,\Lsun}} \new{\mbox{4.24\petm{2.17}{2.00}\E{12}\,\Lsun}} and a
dust mass $M_{\rm dust}$ of \old{\mbox{11\petm{5}{6}\E{8}\,\Msun}} \new{\mbox{14\petm{5}{7}\E{8}\,\Msun}}, all of which are uncorrected for lensing.
...
the derived star formation rate (SFR) given the similar \fir luminosity\old{.Yet, the dust mass is higher by a factor of $\sim$2 in the former but consistent within the uncertainties.}{\new, and
...
The solid black line shows the best-fit SED model with dust attenuation \old{\mbox{(light blue solid line)
obtained using the \ncode{magphys} code.}}\new{obtained using the \mbox{\ncode{magphys}} code, whereas
...
\new{The properties of RXJ1131 and the companion derived in this section are summarized in \Tab{prop}.
\input{table_propRXJ}}
...
We find a dynamical gas mass fraction of $f_{\rm gas}$\eq$M_{\rm gas}$/$M_{\rm dyn}$\eq\old{19\pmm5\%}\new{18\pmm4\%}
% , where the uncertainty is based on that of the gas mass.
and a baryonic gas mass fraction of $f_\textrm{mol}$\eq$M_{\rm gas}$/($M_{\rm gas} + M_*$)\eq\old{\mbox{32\petm{7}{12}\% for RXJ1131}}\new{\mbox{34\pmm16\%} for the merger system (i.e., RXJ1131 and companion)}.
...
Both the dynamical and baryonic gas mass fractions of RXJ1131\new{+companion} are thus consistent with the trend of decreasing molecular gas content since $z$\ssim2 %(e.g., \citealt{Lagos11a, Popping12a, Genzel15a})
...
\old{40\pmm34}\new{54\pmm13}.   %  (1.38e2+0.192e2)/16*5.5 +/- ((0.33/1.38)**2+(0.09/1.92)**2 + (12/16)**2)**.5*54
\old{This would be higher by a factor of two if we were to adopt a dust mass from the other SED fit that is unconstrained at 24\,$\micron$.}
...
The first set of lines is at $z$\ssim\old{0.653}\new{0.654}, including the narrow component of the Balmer lines, the \oiii lines, and the \mgii absorption line; the second set is at $z$\ssim0.658, including the broad component of the Balmer lines and
...
\old{On the other hand, the second set of lines is blueshifted by $\sim$780\,\kms, indicating that the broad line region (BLR) of the AGN is dynamically offset from the centroid of its host galaxy.}
\new{On the other hand, the second set of lines is redshifted by $\sim$715\,\kms.}
...
\new{Offset between BLR and NLR lines have been reported in literature, e.g., 
\citet{Richards02a} find a}
 median of 97\kms and a dispersion of \mbox{269\,\kms} in the distribution of
\old{the offset between [Mg\,{\scriptsize II}] and [O\,{\scriptsize III}] lines, suggesting
that large offsets are uncommon. Nevertheless,
offsets as large as \mbox{$\sim$\,500\,\kms} have been observed in some cases.}
\new{the offset between [Mg\,{\scriptsize II}] and [O\,{\scriptsize III}] lines in an SDSS sample of $>$3800 quasars, 
and \mbox{\citet{Bonning07a}} find a mean offset of \mbox{100\,\kms} with a dispersion of \mbox{212\,\kms} %FWHM = 500
between the broad component of
\mbox{H$\beta$ and [O\,{\scriptsize III}]} lines in a sample of $\sim$2600 quasars at 0.1$<$$z$$<$0.81,
illustrating that large offsets (\mbox{$\Delta v$$\gtrsim$\,500\,\kms}) are uncommon but have been observed in some cases.}

\new{Common interpretations invoked to explain offsets between BLR and systemic redshifts include
e.g., outflow/inflow of gas in the BLR, rotation of the accretion disk, viewing angle towards the accretion disk, 
inclination effect, in which clumps in the accretion disk may block emission towards the far side of the disk, and thus the observed BLR emission is only
originating from
the redshifted inflowing gas component in the near side of the accretion disk of RXJ1131.
In the latter, \citet{Sluse07a} report a covering factor of 20\% based on \mgii absorption line at $z$\eq0.654.
Additionally, differentially lensing of the compact BLR emission by microlensing in RXJ1131\citep[\eg][]{Sluse07a, Sluse12a} 
may have boosted the redshifted component more than the blueshifted component,
thereby biasing the BLR line centroids towards longer wavelengths.}
...
Sluse07:
"Another remarkable result is the presence in our spectra of a \mgii absorption doublet blueshifted at $z$\eq0.654. 
According to its velocity shift ($\Delta v$\ssim$-$660\,\kms). 
These lines disappear from the spectrum ratios A/B and C/B. This indicates that the absorbed flux is proportional to the flux coming from the continuum+BLR. This implies that the region at the origin of the absorption must cover both the continuum and the BLRs and that, within the uncertainties, their depths are identical in the spectra of the three images A, B, and C."
ok.. so is it because of this broad absorption component of \mgii that is at the same $z$ as the NLR lines, and therefore implying that the BLR and 
the AGN is not really spatially and kinematically offset, 
but the offset is truly just a manifestation of a rotating disk + other kinematics (+ absorption of continuum by BLR moving towards us, redshfiting the line centroid, + inflow of material + clumps blocking the far side inflow?)
}
...
\new{Alternatively, the observed offset 
may be explained by a more extreme scenario of a recoiling black hole (BH),}
...
Depending on their initial conditions \new{(e.g., black hole mass ratio, spin-orbit orientation, spin magnitude)}, numerical relativity simulations have shown that
the recoil velocity can reach up to \mbox{$\sim$4000\,\kms} for spinning BHs\old{\mbox{\citep[\eg][]{Campanelli07a}}}\new{,with a typical offset recoil velocity of $v_{\rm kick}$\ssim100\,$-$\,500\,\kms 
\mbox{\citep[\eg][]{Libeskind06a,Campanelli07a}}}.
Several sources have been proposed as recoiling BH candidates, such as CID-42 at \mbox{$z$\,=\,0.359 \citep{Civano10a}} and
SDSS 0956+5127 at \mbox{$z$\,$\sim$\,0.714 \citep{Steinhardt12a}}\old{. One notable system is}\new{, and} SDSSJ0927+2943 at \mbox{$z$\,$\sim$\,0.713}, where
a set of redshifted narrow lines and a second set of blueshifted broad AGN lines
have been observed \mbox{\citep{Komossa08a}}\old{, similar to the case for RXJ1131}.
...
\new{The available data do not provide direct evidence favoring any of the above scenarios, 
we therefore cannot rule out any of the above plausible scenarios; $\lesssim$1-kpc
resolution observations probing the morphology, structures and kinematics of the (ionized) gas and 
stellar (e.g., via H$\alpha$ kinematics measurements) would be useful to distinguish between these scenarios.}

\subsection{The $M_{\rm BH}$$-$\mbulge Relation}
We find a $M_{\rm BH}$$/$$M_{\rm bulge}$ ratio of \old{\mbox{$>$0.27\petm{11}{8}\%}} \new{\mbox{$>$0.27\petm{0.11}{0.08}\%}}
...
but the optical BLR lines are redshifted by \old{$\sim$780\,\kms}\new{$\sim$715\,\kms}.{\bf MAY ADD STUFF ABOUT RECOIL BH..}
\old{This implies that the AGN is offset from the dynamical center of its host galaxy.
...
is typically \mbox{$\sim$100\pmm270\,\kms},
...
$M_{\rm BH}$$/$$M_{\rm bulge}$$>$\old{\mbox{0.27\petm{11}{8}\%}}\new{\mbox{0.27\petm{0.11}{0.08}\%}} for RXJ1131, providing
