...
$M_{*}$\eq(3\pmm1)\E{10}\,\Msun, a star formation rate of SFR$_{\rm FIR}$\eq(120\pmm63)\,\sfrU, and
a star formation efficiency and specific SFR comparable to non-quasar host galaxies at $z$\ssim1.
This together with a gas mass fraction consistent with the trend of evolution indicate 
that no quenching of star formation is seen in RXJ1131.
Our results therefore suggest that 
the decrease in molecular gas mass fraction towards lower redshift 
plays a dominant role 
in the decline of cosmic star formation history even in quasar host galaxies.}
\end{abstract}
...
2\,mm flux. 
In this case, the 2\,mm flux of the foreground galaxy would be lower than the value reported here and yield a steeper slope.
This would also explain the flat spectrum found for the foreground galaxy, which is atypical of elliptical galaxies. 
Assuming a spectral slope of $\alpha$\ssim$-$0.7 for synchrotron radiation in RXJ1131, we expect
...
\new{In addition, a SFE and a sSFR similar to those of high-$z$ disk 
galaxies, which are not known to host an AGN,
together with a molecular gas mass fraction that follows the reported trend of evolution (\Sec{frac})
suggest that no quenching of star formation is observed in RXJ1131, despite 
that fact that it is hosting a quasar.
Hence, the decline in star formation history since $z$\ssim2 even for AGN host galaxies is likely
a manifestation of the evolution in the molecular gas content rather than negative feedback driven by their central AGNs.
% The decrease in molecular gas mass fraction may be due to 
% decrease in intergalactic cold gas accretion (flows of cold gas/cold gas accretion from the IGM).
}
...
to that of RXJ1131 in this discussion.}.\new{
...
\new{This picture is in agreement with that based on the \mbox{$M_{\rm BH}$$-$$M_{\rm bulge}$} relation,
...
\new{Theoretical studies have suggested that the negative feedback from an AGN may remove a 
large fraction of molecular gas from its host galaxy, thereby quenching its star formation \mbox{\citep[e.g., ][]{DiMatteo05a}}.
In this study, we find that the SFE and sSFR derived for RXJ1131 are comparable to those of 
non-AGN host galaxies at $z$\ssim1$-$1.5, and that the 
derived molecular gas mass fraction is consistent with the expected trend of evolution reported in other studies. 
We thus conclude that no negative feedback from the AGN is seen on the molecular gas content 
and on the star formation activity in RXJ1131, albeit hosting a quasar. % at the resolution of our \obs 
% Therefore, we propose that the decline in star formation history since $z$\ssim2 even for AGN host galaxies is 
% a manifestation of the evolution in the molecular gas content 
% rather than
% due to negative feedback driven by their central AGNs.
This suggests that even for AGN host galaxies, 
the decrease in molecular gas mass fraction towards lower redshift
is the main reason for the decline in cosmic star formation history since $z$\ssim2.}
