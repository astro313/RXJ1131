...
%DIF DEL ms_338aba5.tex   Tue Aug 30 15:26:14 2016
%DIF ADD ms.tex           Tue Aug 30 15:26:16 2016
\usepackage{amsmath}
...
RXS\,J1131$-$1231 \DIFdelbegin \DIFdel{(hereafter RXJ1131) }\DIFdelend at $z$\,=\,0.654 obtained using the
...
the host galaxy is an extended rotating disk\DIFaddbegin \DIFadd{, with a CO size }\DIFaddend of $R_{\rm CO}$$\sim$6\,kpc and
a dynamical mass of $M_{\rm dyn}$\ssim8\E{10}\,\Msun.
In addition, we find a secondary CO-emitting source near \DIFdelbegin \DIFdel{RXJ1131 }\DIFdelend \DIFaddbegin \DIFadd{RXS}\,\DIFadd{J1131$-$1231 }\DIFaddend whose location is
...
and \ssim2\E{9}\,\Msun for \DIFdelbegin \DIFdel{RXJ1131 }\DIFdelend \DIFaddbegin \DIFadd{RXS}\,\DIFadd{J1131$-$1231 }\DIFaddend and the companion, respectively.
The gas mass fraction of $\sim$19\% inferred for \DIFdelbegin \DIFdel{RXJ1131 }\DIFdelend \DIFaddbegin \DIFadd{RXS}\,\DIFadd{J1131$-$1231 }\DIFaddend is consistent with the trend of decreasing molecular gas fraction since $z$\ssim2 reported in recent studies.
We find lensing-corrected stellar and dust masses, IR luminosity, and
star formation rate of
$M_{*}$\ssim3\E{10}\,\Msun, $M_{\rm dust}$\ssim4\E{8}\,\Msun, $L_{\rm IR}$\ssim1.5\E{12}\,\Lsun,  and SFR$_{\rm FIR}$\ssim120\,\sfrU for \DIFdelbegin \DIFdel{RXJ1131.
}\DIFdelend \DIFaddbegin \DIFadd{RXS}\,\DIFadd{J1131$-$1231.
}\DIFaddend The source-plane morphologies of its gas and stellar populations
indicate that the star-formation activity may be as extended as the molecular gas reservoir.
We find a $M_{\rm BH}$$/$$M_{\rm bulge}$ ratio of $>$0.27\petm{11}{8}\% \DIFdelbegin \DIFdel{that }\DIFdelend \DIFaddbegin \DIFadd{which }\DIFaddend is higher
than the local value
but consistent with other galaxies at this epoch, suggesting that the bulk of the black hole mass of \DIFdelbegin \DIFdel{RXJ1131 is already }\DIFdelend \DIFaddbegin \DIFadd{RXS}\,\DIFadd{J1131$-$1231 is largely }\DIFaddend in place while its stellar bulge is still assembling.
\end{abstract}
...
\DIFaddbegin \DIFadd{a modest sample of }\DIFaddend $\sim$$30$ ultra-luminous infrared galaxies \citep[ULIRGs; ][]{Combes11a, Combes13a}. %18+15
...
at intermediate redshifts \DIFdelbegin \DIFdel{.
This is owed to the difficulties in measuring stellar }\DIFdelend \DIFaddbegin \DIFadd{due to the difficulty 
...
Strong gravitational lensing provides the magnification necessary to spatially separate the AGN }\DIFaddend emission \DIFdelbegin \DIFdel{in quasar host galaxies which is typically
saturated by the sidelobes from their quasars.
With strong gravitational lensing , emission }\DIFdelend from the \DIFdelbegin \DIFdel{background quasar and its host galaxy originating from
different source-plane locations with different spatial extent is being magnified and stretched out inhomogenously,
allowing their emissionto be
spatially resolved over more beams to reduce }\DIFdelend \DIFaddbegin \DIFadd{host galaxy stellar emission, significantly improving }\DIFaddend the dynamic range \DIFdelbegin \DIFdel{, and thus
measurements of the stellar emission in the host galaxy}\DIFdelend \DIFaddbegin \DIFadd{that can be achieved in studies of their host galaxies with current instruments}\DIFaddend .
...
study the properties of its molecular gas, \DIFdelbegin \DIFdel{the }\DIFdelend dust and stellar populations.
...
an effective bandwidth of 3.6 GHz (dual polarization) and a \DIFaddbegin \DIFadd{native }\DIFaddend spectral resolution of 1.95\,MHz
($\sim$\,$4.2$\,\kms).
...
We apply \DIFaddbegin \DIFadd{an }\DIFaddend astrometric correction to the optical image by adopting the VLA 5\,GHz map as the
...
We subtract a point source model in the $uv$-plane to remove the unresolved \DIFdelbegin \DIFdel{emission }\DIFdelend \DIFaddbegin \DIFadd{part of the
emission, }\DIFaddend which we here assume to be dominated by the foreground galaxy. The peak flux (0.39\,$\pm$\,0.08\,mJy)
...
Our approach \DIFdelbegin \DIFdel{is similar to }\DIFdelend \DIFaddbegin \DIFadd{follows a similar strategy as }\DIFaddend \citet{Riechers08a}, who reconstruct a source-plane
velocity gradient and constrain the gas dynamics in \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{the }\DIFaddend $z$\,$>$\,4 quasar \DIFaddbegin \DIFadd{host galaxy of
 }\DIFaddend PSS J2322$+$1944,
\DIFdelbegin \DIFdel{whose host galaxy }\DIFdelend \DIFaddbegin \DIFadd{which }\DIFaddend is also lensed into an Einstein ring configuration.
...
Since the $V$-band \DIFdelbegin \DIFdel{dynamical mass }\DIFdelend \DIFaddbegin \DIFadd{based dynamical mass measurement }\DIFaddend is substantially lower than the gas mass,
...
40\pmm34.
This would be \DIFaddbegin \DIFadd{higher by }\DIFaddend a factor of two \DIFdelbegin \DIFdel{higher }\DIFdelend if we were to adopt a dust mass from the other SED fit that is unconstrained at 24\,$\micron$.
...
the \DIFdelbegin \DIFdel{slight enhancement in sSFR }\DIFdelend \DIFaddbegin \DIFadd{small elevation in sSFR over the main sequence at $z$}\ssim0\DIFadd{.7 }\DIFaddend suggests
that the \SF \DIFaddbegin \DIFadd{activity }\DIFaddend in RXJ1131 may be \DIFdelbegin \DIFdel{predominantly driven }\DIFdelend \DIFaddbegin \DIFadd{enhanced }\DIFaddend by interactions with the companion.
...
We find a specific \SF rate (sSFR\ssim4 Gyr\pmOne) that is $\lesssim$1.5$\sigma\DIFdelbegin \DIFdel{$ higher than those of ``main sequence'' galaxies.
...
gravitational torques provided by stellar components is reduced in such a system \mbox{%DIFAUXCMD
\citep{Springel05a, Robertson06a, Hopkins09a}
}%DIFAUXCMD
.
...
but the optical BLR lines are blueshifted by $}\DIFdelend \DIFaddbegin \DIFadd{$ higher than those of ``main sequence'' galaxies.
...
Using the CO redshift as the systemic redshift for the host galaxy of RXJ1131, we find
that the redshift inferred from the NLR lines reported in previous studies are consistent with this systemic redshift
but the optical BLR lines are blueshifted by $}\DIFaddend \sim$780\,\kms.
