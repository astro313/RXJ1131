...
\newcommand{\old}[1]{\textcolor{airforceblue}{\protect\st{#1}}} % {\textcolor{green!55!blue}{\bf #1}} or  {\textcolor{OliveGreen}{\bf #1}}
% -----------------------------------------------------------------------------------------------
...
We find a $M_{\rm BH}$$/$$M_{\rm bulge}$ ratio of \old{\protect$>$0.27\petm{11}{8}\%} \new{$>$0.27\petm{0.11}{0.08}\%} which is higher
than the 
...
\old{\protect{are extracted by integrating over $v$\,$\in$[0, 409] \kms and $\in$[$-$325,0] \kms, respectively.}}
\new{\protect{are extracted by integrating over $v$\,$\in$[$-$19, 357] \kms and $\in$[$-$395, $-$19] \kms, respectively.}}
...
The velocity scale is with respect to \old{\protect{$z$=0.6537, which corresponds to the
dynamical center of the \bco line.}} \new{\protect{$z$=0.6541, which corresponds to the
...
\caption{Left: \old{\protect{Source-plane positions from best-fit \bco lens models are indicated with their associated uncertainties atop
the observed first moment map}}
\new{\protect{Source-plane positions obtained from the best-fit lens models (presented in \Sec{lensmodel}) are shown 
...
\old{\protect{3.81\petm{2.04}{1.92}\E{12}\,\Lsun}} \new{\protect{3.81\petm{1.92}{1.97}\E{12}\,\Lsun}}, and a
...
\LIR (rest-frame 8\,$-$\,1000\,\micron) of \old{\protect{9.71\petm{6.14}{-6.05}\E{12}\,\Lsun}} \new{\protect{8.67\petm{5.27}{5.27}\E{12}\,\Lsun}},
a \fir luminosity \LFIR of \old{\protect{4.72\petm{2.54}{2.26}\E{12}\,\Lsun}} \new{\protect{4.24\petm{2.17}{2.00}\E{12}\,\Lsun}} and a
dust mass $M_{\rm dust}$ of \old{\protect{11\petm{5}{6}\E{8}\,\Msun}} \new{\protect{14\petm{5}{7}\E{8}\,\Msun}}, all of which are uncorrected for lensing.
...
The solid black line shows the best-fit SED model with dust attenuation \old{\protect{(light blue solid line)
obtained using the \ncode{magphys} code.}}\new{\protect{obtained using the \ncode{magphys} code, whereas
...
and a baryonic gas mass fraction of $f_\textrm{mol}$\eq$M_{\rm gas}$/($M_{\rm gas} + M_*$)\eq\old{\protect{32\petm{7}{12}\% for RXJ1131}}\new{\protect{34\pmm16\% for the merger system (i.e., RXJ1131 and companion)}}.
...
\old{\protect{One explanation for the offset may arise from the fact that BLRs are gravitationally bound to
...
\old{\protect{Alternatively, large velocity offsets between emission lines of the
...
We find a $M_{\rm BH}$$/$$M_{\rm bulge}$ ratio of \old{\protect{$>$0.27\petm{11}{8}\%}} \new{\protect{$>$0.27\petm{0.11}{0.08}\%}}
...
\old{\protect{This implies that the AGN is offset from the dynamical center of its host galaxy.
...
$M_{\rm BH}$$/$$M_{\rm bulge}$$>$\old{\protect{0.27\petm{11}{8}\%}}\new{\protect{0.27\petm{0.11}{0.08}\%}} for RXJ1131, providing
