...
\old{\mbox{The velocity scale is with respect to $z$=0.6537, which corresponds to the
dynamical center of the \bco line.}}\new{\mbox{The velocity scale is the same as in \Fig{CO21spec}.}} The spectral resolution for \cco and \bco
...
and a baryonic gas mass fraction of $f_\textrm{mol}$\eq$M_{\rm gas}$/($M_{\rm gas} + M^*$)\old{\mbox{\eq32\petm{7}{12}\% for RXJ1131.}} \new{\mbox{\eq34\pmm16\%} for the merger system (i.e., RXJ1131 and companion).}
...
\mbox{\citep{Madau04a, Bonning07a, Loeb07a}}.}
\new{A recoiling black hole is expected
when a pair of uneven mass BH coalesce, during which their orbital energy is being released
...
but the optical BLR lines are blueshifted by \old{$\sim$780\,\kms.
