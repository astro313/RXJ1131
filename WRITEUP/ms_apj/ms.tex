...
\newcommand{\old}[1]{\sout{\textcolor{airforceblue}{\bf #1}}}
...
\newcommand{\oii}{\mbox{$[$O{\scriptsize II}$]$~3727\AA}\xspace}
...
$z$\ssim1 disk galaxies not hosting quasars.
The implied gas mass fraction of $\sim$18\pmm4\% is consistent with the previously-observed cosmic decline since $z$\ssim2. We thus find no evidence for quenching of star formation in RXS\,J1131$-$1231. This agrees with our finding of an elevated \mbox{$M_{\rm BH}$$/$$M_{\rm bulge}$} ratio of \mbox{$>$0.27\petm{0.11}{0.08}\%} compared to the
...
3\farcs8\pmm0\farcs4$\times$1\farcs9\pmm0\farcs4 and 3\farcs6\pmm0\farcs3$\times$1\farcs5\pmm0\farcs3, separated by $\sim$2\farcs2 in RA and $\sim$1\farcs7 in Dec.
...
\tablenotetext{c}{Flux extracted from the residual map after subtracting a point-source model. For SED modeling, we use $S_{\rm 2mm}$\eq0.27\pmm0.08\,mJy to exclude synchrotron emission (see \Sec{deblend}).}
...
Einstein Radius\tna  & (\arcsec)   & 1.833$\pm$0.002
\enddata
\label{tab:lens}
\tablenotetext{a}{This corresponds to mass of $M(\theta$\,$<$\,$\theta_{\rm E})$\eq(7.42\pmm0.02)\E{11}\Msun within the Einstein radius.}
