...
\def\aips {Astronomical Image Processing System (AIPS)\xspace}
\def\casa {Common Astronomy Software Applications (CASA)\xspace}
% Long words
\newcommand{\lowZ}{low-metallicity}
\newcommand{\mulw}{multi-wavelength}
\newcommand{\SF}{star-formation}
\newcommand{\gl}{gravitationally lensed}
% Wavelength regimes
