...
nucleus (AGN), which also implies a large gas content to begin with. % to drives these activities.
...
% 
% If we use FWHM of CO21 line to extract CO32 Intensity: I = Jy km/s over chan=[]
