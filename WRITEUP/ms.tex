...
This yields \LFIR of $($8.8\pmm0.4$)$\E{11}$(\mu_{\rm L}$/5.5$)$\,\Lsun and
a SFR of $($150\pmm 70$)$\,\sfrU.
This implies RXJ1131 is considered a LIRG in regards to their
sample, and consequently,
the SFR of RXJ1131 is lower than that of the C13 sample
(SFR\,$>$\,200, with an average of 1200).
...
% This also indicates that the positive correlation
% in the linewidth-size relation
...
comparable to the C13 sample ($M_{\rm gas}$\,=\,1.5\E{10}\Msun) within the
uncertainties.
...
$f_{\rm gas-dust}$\,=\,70\petm{blah}{blah}, which is consistent lower than C13
