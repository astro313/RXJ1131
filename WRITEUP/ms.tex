...
We find a lensing-corrected gas mass of $M_{\rm gas}$\ssim1.4\E{10}\,\Msun in the host galaxy and 
\ssim2\E{9}\,\Msun in the companion (gas mass ratio $\sim$7:1). 
The CO disk is extended over $\sim$6\,kpc, which yields a dynamical mass of $M_{\rm dyn}$\ssim8\E{10}\,\Msun
for the host galaxy. This corresponds to a gas mass fraction of $\sim$19\%, confirming its gas-rich nature.
This fraction also confirms the trend of decreasing gas fraction since $z$\ssim1, which is responsible for the decline of
the cosmic \SF rate and black hole accretion rate densities.
Fitting dust SED models, we derive a lensing-corrected dust mass of $M_{\rm dust}$ = 4\E{8}\,\Msun, a 
lensing-corrected $L_{\rm IR}$\ssim1.5\E{12}\,\Lsun, and a SFR$_{\rm FIR}$\eq120\pmm63 \sfrU, 
...
which allows us to provide the first dynamical constraint on the Magorrian relation at intermediate redshift.
\end{abstract}
...
In \Sec{HST}, we describe our astrometric corrections applied to align an {\it HST} image with our VLA radio image.
...
We detect \cco line emission toward RXJ1131 at $\gtrsim5\sigma$ significance.
...
If we instead fit the intrinsic line profiles with single-Gaussians, we find a FWHM of 600\pmm160\,\kms for RXJ1131
...
model as the unobscured source size, we find a dynamical mass of 
...
Theoretical simulations suggest that the disk component of a gas-rich progenitor galaxy with low SFE can be
