...
while their stellar cores remain % distinct
...
% tidal tails if they have already encountered.
...
A classical picture of mergers is that they are responsible for the formation of local spheroids.
The growing consensus that more realistic
treatments of star formation and supernovae feedback ? which suppress
efficient early star formation ? play a critical role in enabling
disc formation in simulations.
Mergers are expected to evolve into
local ellipticals or large-disks (bulge dominated; Springel05a, Robertson06a)
and disc with low B/D ratio (Hopkins09a) from simulations.
Reason for suppression of bulge formation in mergers of gas-rich discs (even in major merger):
 because in systems that are sufficiently gas-rich, there's little/no significant (collisionless) stellar material available to torque away the cold gas in the disc; little/no angular momentum is lost, and gas will rapidly reform a cold disc in the background of the relaxing stellar potential (collisionless):
Gas, being collisional, cannot violently relax, but must
have its angular momentum torqued away in order to dissipate and
build a bulge by forming stars in a central starburst (\ie gas lose angular momnentum to stars in the perturbed disk and fall toward center). In a merger,
...
1996; cold gas with no angular momentum will be largely unable to form any sort of disk, and that a galaxy?s worth of gas compressed to high densities and small radii will inevitably form a large mass in stars). But it no significant stellar feature is there (e.g. in the more gas-rich ones (Hopkins09a), the final product will have a bulge mass fraction $\sim$0.1$-$0.2).
i.e. small bulge disc can also form from minor merger or major merger (if gas fraction is sufficiently large)

% fate
But since the two galaxies are found to be gas-rich, can dissipates energy
through e.g. frictional forces and drive gas toward the center, leading to
higher rotational velocity and dispersion in the central region.
In that case,
it is unlikely that RXJ1131 will evolve into present-day massive ellipticals (M$\gtrsim$1\E{12}\,\Msun), since RXJ1131 is now a minor merger.
Instead, it is likely to evolve into ``normal'' ellipticals (depending on the feedback, since a major gas-rich merger without AGN feedback does not, by itself, produce a red and dead spheroidal galaxy (Lotz08a).) or massive disk galaxies where the stellar populations from the companion is dragged and added onto the dominant galaxy RXJ1131 to thicken the disc, consistent with recent models (disk from gas-rich major merger:
\citep[\eg][]{Lotz08a, Robertson06a}.

% evolve into disk
Given the
massive gas content distributed in an extended configuration/disc with its SFE on the low end of other ULIRGs, we suggest RXJ1131 may evolve into the
latter (large-disk) unless the ``companion'' somehow triggers some other
mechanisms in the latter stage, transporting the gas 
toward the central nuclear region and to simulate a final burst to form a large bulge or somehow destroy the
disc in RXJ1131.
