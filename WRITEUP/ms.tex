% Done: PdBI observations, VLA observations, CARMA obs, HST astrometry
%
%
%
%
...
images from the Hubble Legacy Archive\footnote{http://hla.stsci.edu/hla_faq.
html}. Such astrometric correction is critical to avoid artificial spatial
offsets between emission and to carry out our lens modeling, as the absolute
position of the foreground lensing galaxy is guided by its coordinates in the
optical image, where its emission is clearly detected.
...
the SFH, this implies the change in cosmic SFD is due to change in gas content. SFE
