...
We here quote a conservative uncertainty, which is derived by adding those associated with the flux density of the 
point-source model ($\delta S_{\nu}$\eq0.088\,mJy) and 
the peak flux in the residual map (0.08\,mJy) 
in quadrature. We caution that this does not account for that in the 
...
for the background source due to synchrotron radiation,
and thus a flux excess of $S_{\rm 2mm}$\eq0.27\pmm0.08\,mJy relative to this expectation
...
the lensed arc. This suggests that the CO-emitting region in RXJ1131 is extended.
...
This indicates that the spatial positions and extents of different stellar populations 
within the host galaxy are dissimilar with respect to the caustic which may be a result of dust extinction and reddening.
...
A secondary effect is likely a result of including the CO emission from the companion in the most redshifted velocity channels.
...
dust mass of 16\petm{5}{12}\E{8}\,\Msun, all of which are not corrected for lensing magnification.
...
\citet{Richards02a} find an offset of 
...
BLR line emission to be dominated by gas that is flowing into the central BH or the receding component of
the accretion disk.
...
The latter scenario would also explain the high black hole spin parameter reported by \citet[$a$\ssim0.9][]{Reis14a}, but 
