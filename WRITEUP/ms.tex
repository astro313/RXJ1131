...
The moderate mass black hole $M_{\rm BH}$\eq8\E{7}\Msun \citep{Sluse12a} %based on H beta line
residing in RXJ1131 is rotating with a high spin parameter \citep[$a$\,$\sim$\,0.9;][]{Reis14a}, and
is radiating at an intrinsic bolometric luminosity of $L_{\rm bol, X}$\eq1.3\E{45}\, ergs\,s\pmOne \citep{Pooley07a}.
...
a large portion of the dust from SED fitting is residing in the companion and not RXJ1131. %so probably also means dust magnification factor is quite different, probably higher, because the companion CO magnification is also higher than the median CO, implying its in a lensing configuration with higher magnification.
