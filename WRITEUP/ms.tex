...
% also ULIRGs are found to be thermalized up to Jup = 3 or 4, but not needed to say here
...
$M_{\rm gas}$ of (1.92\pmm0.09)\,\E{9} \Msun. 
...
the classification scheme/convention commonly used in literature.
...
suggests that the 
overall CO emitting region is extended.
...
implying an intrinsically symmetric line profile. 
