...
the host galaxy is an extended rotating disk of $R_{\rm CO}$$\sim$6\,kpc and
...
and \ssim2\E{9}\,\Msun for RXJ1131 and the companion, respectively.
The gas mass fraction of $\sim$19\% inferred for RXJ1131 is consistent with the trend of decreasing molecular gas fraction since $z$\ssim2 reported in recent studies.
We find lensing-corrected stellar and dust masses, IR luminosity, and
star formation rate of
$M_{*}$\ssim3\E{10}\,\Msun, $M_{\rm dust}$\ssim4\E{8}\,\Msun, $L_{\rm IR}$\ssim1.5\E{12}\,\Lsun,  and SFR$_{\rm FIR}$\ssim120\,\sfrU for RXJ1131.
...
but consistent with other galaxies at this epoch, suggesting that the bulk of the black hole mass of RXJ1131 is already in place while its stellar bulge is still assembling.
\end{abstract}
...
spatially unresolved CO observations of $\sim$$30$ ultra-luminous infrared galaxies \citep[ULIRGs; ][]{Combes11a, Combes13a}. %18+15
...
measuring stellar emission in quasar host galaxies which is typically
...
spatially resolved over more beams to reduce the dynamic range, and thus 
...
study the properties of its molecular gas, the dust and stellar populations.
...
an effective bandwidth of 3.6 GHz (dual polarization) and a spectral resolution of 1.95\,MHz
($\sim$\,$4.2$\,\kms).
...
We apply astrometric correction to the optical image by adopting the VLA 5\,GHz map as the
...
Our approach is similar to \citet{Riechers08a}, who reconstruct a source-plane
...
Since the $V$-band dynamical mass is substantially lower than the gas mass,
...
40\pmm34.
This would be a factor of two higher if we were to adopt a dust mass from the other SED fit that is unconstrained at 24\,$\micron$.
...
the slight enhancement in sSFR may suggest
that the \SF in RXJ1131 is driven by the interactions with the companion.
...
$M_{\rm BH}$$/$$M_{\rm bulge}$$>$0.27\petm{11}{8}\% for  of RXJ1131, providing
