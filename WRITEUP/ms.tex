...
The best-fit SEDs are shown in \Fig{SED} and the resulting parameters
are listed in \Tab{SED}.
...
While our result is consistent with previous studies of RXJ1131, this
contrast strongly with studies of mergers, where powerful AGN are
usually found in late stage mergers (Yuan+10, Iwasawa+11) and
that only major mergers near their final
coalescence can power/provide \LIR\,$>$\,10$^{12}$\,\Lsun, based on
a recent study of a sample of 65 local U/LIRGs
(\LIR\,=\,10$^{11-12.5}$\,\Lsun; $z$\,$<$\,0.1; Larson+16).
...
but there are outliers --  Ueda+14 find
...
merger in the context of the results reported by Larson+16.
