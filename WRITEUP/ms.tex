...
We then attempt to characterize/constrain the molecular gas kinematics using an
...
The first set of lines is at $z$\ssim0.654, including the narrow component of the Balmer lines, the \oiii lines, and the \mgii absorption line; the second set is at $z$\ssim0.658, including the broad component of the Balmer lines and
