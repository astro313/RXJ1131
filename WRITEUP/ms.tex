...
according to the overall median in the preliminary models, as listed in \Tab{lens}. 
...
By modeling different kinematic components, we find that the magnification factor ranges from BLAH to BLAH. The various magnification factors are listed in \Tab{model}.
