...
for this model, we find a  \LFIR of 4.72\petm{2.54}{-2.26}\E{12}\,\Lsun and a $M_{\rm dust}$ of 11\petm{5}{6}\E{8}\,\Msun.
...
The dust temperature from both models is consistent with that
of ULIRGs at 0.6\,$<$\,$z$\,$<$\,1.0 (54\,$\pm$\,5\,K, \citealt{Combes13a}).
...
\fir luminosity from the latter fit is slightly higher than the former, but
...
the derived star formation rate (SFR) given the similar \LFIR.
Yet, the dust mass is higher in the former model (but consistent within the
...
We correct for lensing using the median magnification factor 
derived from the CO lens models. Assuming a Salpeter initial 
mass function, we find the SFR of blah using a standard SK law.
