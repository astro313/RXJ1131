...
carried out using \ncode{sussextractor} within Herschel Interactive
...
spatial resolution, the symmetric velocity gradient lean support
to the case of a minor merger.
...
than in local ULIRGs (240\,\kms; \citealt[][]{Solomon97a}).
...
of (2.8$\pm$1.3)\,\E{10} \Msun. This is likely
an overestimation due to a contribution from the companion, but is
nevertheless consistent with the C13 sample ($M_{\rm gas}$\,=\,1.5\E{10}\Msun) within the
uncertainties. 

% gas-to-dyn ratio
Using the dynamical mass of BLAH (see \Sec{dynamics}), we find
