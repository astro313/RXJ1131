...
\begin{figure}[!htbp]
\includegraphics[trim=12 27 0 1, clip, width=0.47\textwidth]{../Figures/F555W_ContPdBI.eps}
\includegraphics[trim=10 5 0 0, clip, width=0.47\textwidth]{../Figures/F555W_ContVLA.eps}
...
% constraining the molecular gas fraction
% as a function of stellar mass together with 
% the molecular gas fraction as a function of AGN luminosity normalized 
% by the stellar mass ($L_{\rm QSO}$$/$M$_*$) for a sample of AGN host galaxies at different redshifts
% between 0$<$\,$z$\,$<$2 % at a given galaxy mass 
