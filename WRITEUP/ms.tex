...
magnified by similar amounts, the line intensities
...
from the model of this channel to derive the gas mass in the companion.
Without direct \rot{1}{0} measurements, we derive \rot{1}{0} intensity
assuming a brightness temperature ratio of $r_{\rm 21}$\,=\,1, which was chosen
solely to facilitate a comparison with other U/LIRGs. % also ULIRGs are found to be thermalized up to Jup = 3 or 4
...
$M_{\rm gas}$ of (1.68\pmm0.68)\,\E{10} \Msun. 
%statistical unc. only (i.e. draw from from distributions of on mag. factor & intrinsic flux)
...
This yields $I_{\small \bco}$\,=\,5.41$\pm$2.71 Jy\,\kms,
...
$M_{\rm gas}$\,=\,(3.17\pmm1.59)\,\E{10} \Msun.
The implies a gas mass ratio of $\sim$2:1.
Therefore, the system is a gas-rich major merger according to
...
$H$-, $V$-, and $I$-band has been detected with a
magnification factor decreasing from 10.9 to 7.8 (C06),
the highly asymmetric \bco line profile suggests that
differential lensing is also non-negligible for the CO emission, whereby
causing the redshifted emission to be apparently much brighter than the
blueshifted component.
Such an effect is consistent with the source plane
positions relative to the caustics in \Fig{model}; the red wing emission mainly originates near the cusp
in the caustic, whereas the blue wing emission is located beyond the caustics.
From our best-fit lens models, the magnification factor varies from 8.7 to 3.1 across the \bco line (\Tab{model}).

%If we estimate the intrinsic I:
%red I =
%blue wing I =
...
$M_{\rm gas}$ of (xx\pmm xx)\,\E{10} \Msun. 
BLAH
