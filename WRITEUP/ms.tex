...
\subsection{Velocity Offset and Recoiling BH}
...
In fact, a large velocity offset can also result from a recoiling BH where its
...
numerical relativity simulation have shown that
...
the system may be at its subsequent minor merger stages but was intially
a major merger. 
