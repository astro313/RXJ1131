...
which traces recent massive \SF. The may be explained in part
due to the fact that $V$-band emission is
more susceptible to dust extinction than other bands.
The fact that the molecular gas (fuel for \SF) is more compact
than emission in the $I$ and $H$-bands,
which trace the more evolved stellar population, is consistent
with the picture that stars diffuse outward
after formation \citep{Calzetti01a}.
